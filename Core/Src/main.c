...
/* USER CODE BEGIN PV */
Machine_State_TypeDef state = IDLE;
System_Resources_Typedef sys = {0};
System_Flags_TypeDef flags = {0};
Config_Typedef config = {0};
...
uint16_t Last_Acceleration = 0;
uint16_t Temperature = 0;

char MQTT_Logging[100] = {0};
uint8_t Logging_Buffer[LOGGING_BUFFER_LEN] = {0};
int Address_Offset = 0;

char LTE_Ack_buffer[100] = {0};

uint16_t Seconds_After_Warning = 0;

uint16_t Saves_cnt = 0;
